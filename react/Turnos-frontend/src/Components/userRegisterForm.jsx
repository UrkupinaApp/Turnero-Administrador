      ...
      <div className="registro-card">
        ...
        >
          ...
          <Row gutter={16}>
            ...
            <Col xs={24} md={8}>
              <Form.Item label="Uso" name="uso" rules={[{ required: true, message: 'Seleccione uso' }]}>
                <Select size="large" onChange={v => setUso(v)}>
          ...
          <Row gutter={16}>
            ...
            <Col xs={24} md={6}>
              <Form.Item label="Pasillo" name="pasillo" rules={[{ required: true, message: 'Ingrese pasillo' }]}>
                <Input />
              </Form.Item>
            </Col>
            <Col xs={24} md={6}>
              <Form.Item label="Puesto" name="puesto" rules={[{ required: true, message: 'Ingrese puesto' }]}>
                <Input />
              </Form.Item>
            </Col>
            <Col xs={24} md={6}>
              <Form.Item label="Tamaño del Puesto (mts)" name="tamano_puesto" rules={[{ required: true, message: 'Seleccione el tamaño del puesto' }]}>
                <Select size="large" placeholder="Seleccione tamaño">
          ...
          {/* INQUILINOS */}
          {uso === "ALQUILA" && (
            <Card title="Inquilinos (hasta 2)" className="registro-inquilinos-card">
